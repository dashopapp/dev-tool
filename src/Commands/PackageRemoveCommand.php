...
use Dashopapp\Base\Facades\BaseHelper;
use Dashopapp\Base\Supports\Helper;
use Dashopapp\DevTool\Helper as HelperDevTool;
...
class PackageRemoveCommand extends Command implements PromptsForMissingInput
{
    ...
    protected function processRemove(string $package, string $location): bool
    {
        ...
        $this->components->info(sprintf('Remove <comment>"dashopapp/%s": "*@dev"</comment> to composer.json then run <comment>composer update</comment> to remove this package!', $package));
