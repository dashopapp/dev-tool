...
use Dashopapp\DevTool\Commands\Abstracts\BaseMakeCommand;
use Dashopapp\DevTool\Helper;
use Dashopapp\PluginManagement\Commands\Concern\HasPluginNameValidation;
...
class PluginCreateCommand extends BaseMakeCommand implements PromptsForMissingInput
{
    ...
    public function inputOptions(): array
    {
        return [
            'id' => [
                ...
                'placeholder' => 'E.g.: dashopapp/example-plugin',
                'required' => true,
            ],
            'name' => [
                'label' => 'Name:',
    ...
    protected function registerAdvancedLanguage(): string|null
    {
        ...
        return PHP_EOL . str_repeat(' ', 12) . sprintf("if (defined('LANGUAGE_ADVANCED_MODULE_SCREEN_NAME')) {
                \Dashopapp\LanguageAdvanced\Supports\LanguageAdvancedManager::registerModule(%s::class, [
                    'name',
                ]);
    ...
    protected function importsServiceProvider(): string|null
    {
        ...
        $imports = ['Dashopapp\Base\Facades\DashboardMenu'];
